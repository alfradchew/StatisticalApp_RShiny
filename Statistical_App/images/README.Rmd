...
Run the file __ui.R__ as shown below to load the app:
```{r, fig.width = 2}
knitr::include_graphics("load location.png")
```
...
![alt text](https://raw.githubusercontent.com/alfrad92/statistical-app_RShiny/blob/master/statistical-app_RShiny/Statistical App/R code for readme/layout.png)
...
```{r, fig.width = 2}
knitr::include_graphics("vizualization.png")
```
